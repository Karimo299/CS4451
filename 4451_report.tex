...
Fig.~\ref{fig:logreg_barplot} summarizes the performance across D1–D7.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{logreg_D1_D7_bar_comparison.png}
...
\subsection{SHOULD WE ADD THIS: Comparison of Logistic Regression and SVM}
